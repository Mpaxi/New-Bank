...
{
    class CheckingAccountTypeConfig : IEntityTypeConfiguration<CheckingAccountType>
    {
        public void Configure(EntityTypeBuilder<CheckingAccountType> builder)
        {
            ...
            builder.ToTable("CheckingAccountType");
        }
    }
}
